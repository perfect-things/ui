...
<h3>Normal</h3>
<span class="tooltip-box" id="box1">box with a tooltip</span>
<Tooltip target="box1">Some tooltip text</Tooltip>

<br>

<span class="tooltip-box" id="box2">box with a tooltip</span>
<Tooltip target="box2">
	<h1>Some Title</h1>
...
<span class="tooltip-box" id="box-below">box with a tooltip</span>
<Tooltip position="bottom" target="box-below">Some tooltip text</Tooltip>

<h3>Custom offset</h3>
<span class="tooltip-box" id="box-offset">box with a tooltip</span>
<Tooltip target="box-offset" offset="-20">Smaller offset</Tooltip>

<span class="tooltip-box" id="box-offset2">box with a tooltip</span>
<Tooltip target="box-offset2" offset="20">Bigger offset</Tooltip>


<h3>On Click</h3>
<span class="tooltip-box" id="box3">box with a tooltip</span>
